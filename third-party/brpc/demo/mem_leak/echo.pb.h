...
// repeated string ids = 2;
inline int EchoRequest::_internal_ids_size() const {
  return ids_.size();
}
inline int EchoRequest::ids_size() const {
  return _internal_ids_size();
}
inline void EchoRequest::clear_ids() {
  ids_.Clear();
}
inline std::string* EchoRequest::add_ids() {
  // @@protoc_insertion_point(field_add_mutable:example.EchoRequest.ids)
  return _internal_add_ids();
}
inline const std::string& EchoRequest::_internal_ids(int index) const {
  return ids_.Get(index);
}
inline const std::string& EchoRequest::ids(int index) const {
  // @@protoc_insertion_point(field_get:example.EchoRequest.ids)
  return _internal_ids(index);
}
inline std::string* EchoRequest::mutable_ids(int index) {
  // @@protoc_insertion_point(field_mutable:example.EchoRequest.ids)
  return ids_.Mutable(index);
}
inline void EchoRequest::set_ids(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:example.EchoRequest.ids)
  ids_.Mutable(index)->assign(value);
}
inline void EchoRequest::set_ids(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:example.EchoRequest.ids)
  ids_.Mutable(index)->assign(std::move(value));
}
inline void EchoRequest::set_ids(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  ids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:example.EchoRequest.ids)
}
inline void EchoRequest::set_ids(int index, const char* value, size_t size) {
  ids_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:example.EchoRequest.ids)
}
inline std::string* EchoRequest::_internal_add_ids() {
  return ids_.Add();
}
inline void EchoRequest::add_ids(const std::string& value) {
  ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:example.EchoRequest.ids)
}
inline void EchoRequest::add_ids(std::string&& value) {
  ids_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:example.EchoRequest.ids)
}
inline void EchoRequest::add_ids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:example.EchoRequest.ids)
}
inline void EchoRequest::add_ids(const char* value, size_t size) {
  ids_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:example.EchoRequest.ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
EchoRequest::ids() const {
  // @@protoc_insertion_point(field_list:example.EchoRequest.ids)
  return ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
EchoRequest::mutable_ids() {
  // @@protoc_insertion_point(field_mutable_list:example.EchoRequest.ids)
  return &ids_;
}
